...
Allow players to craft powerful items, enhance them to new heights, socketing gems to the equipments and add unique [Enchantment] —all fully customizable within the Unity Editor.
